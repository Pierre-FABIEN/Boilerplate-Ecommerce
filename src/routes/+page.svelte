...
>
	<h1
		class="h-[100px] w-[300px] text-left font-black italic uppercase text-transparent min-[426px]:h-[200px] min-[426px]:[-webkit-text-stroke-width:2px] min-[601px]:w-[500px] [font-family:'Open_Sans_Variable',sans-serif] [-webkit-text-stroke-width:1px]"
